...
java $JAVA_OPTS -classpath "$CLASS_PATH" -Dlogback.configurationFile="$SCRIPT_DIR/../conf/logback.xml" -Dorg.bitrepository.configDir="$SCRIPT_DIR/../conf/$APP_CONFIG" "$MAIN_CLASS" "$@"
